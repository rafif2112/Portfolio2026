        ...
        <section id="contact" className="flex items-center min-h-auto lg:min-h-[70dvh] px-4 py-8 text-center">
            ...
            >
                ...
                <div className="flex flex-col md:flex-row gap-6">
                    ...
                    <form className="flex flex-col justify-center items-center gap-3 sm:gap-4 mx-auto w-full">
                        ...
                        <InteractiveHoverButton
                            type="submit"
                            className="px-4 sm:px-6 h-8 border border-[#2e2b2b] hover:dark:border-[#efe9e9] sm:h-11 self-start text-sm sm:text-base"
                        >
                            Send Message
                            {/* <Send className="w-4 h-4 sm:w-5 sm:h-5" /> */}
                        </InteractiveHoverButton>
