...
export default function AboutSection() {
    ...
    const { data, loading } = useAppSelector((state) => state.about);
    const { data: contactData, loading: contactLoading } = useAppSelector((state) => state.contact);
    ...
    return (
        <section
            ...
            {loading || contactLoading ? (
                <div className='flex flex-col gap-6 flex-1 w-full order-2 lg:order-1'>
